(function (global, factory) {
  ...
  Head = Head && Object.prototype.hasOwnProperty.call(Head, 'default') ? Head['default'] : Head;
  ...
  var buildTags = function buildTags(config) {
    ...
    if (config.title) {
      ...
      tagsToRender.push(React__default.createElement("title", {
        key: "title"
      }, updatedTitle));
    }
    ...
    if (noindex || nofollow) {
      ...
      tagsToRender.push(React__default.createElement("meta", {
        key: "robots",
        name: "robots",
    ...
    if (config.mobileAlternate) {
      tagsToRender.push(React__default.createElement("link", {
        rel: "alternate",
        key: "mobileAlternate",
    ...
    if (config.additionalMetaTags && config.additionalMetaTags.length > 0) {
      config.additionalMetaTags.forEach(function (tag) {
        tagsToRender.push(React__default.createElement("meta", Object.assign({
  ...
  var _default = /*#__PURE__*/function (_Component) {
    ...
    _proto.render = function render() {
      ...
      return React__default.createElement(Head, null, buildTags({
        title: title,
  ...
  var ArticleJsonLd = function ArticleJsonLd(_ref) {
    ...
    return React__default.createElement(Head, null, React__default.createElement("script", {
